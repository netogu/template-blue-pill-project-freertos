...
SRCDIR 	:= $(abspath ./src)
LIBOPENCM3DIR := $(abspath ./external/libopencm3)
FREERTOSDIR	:= $(abspath ./external/FreeRTOS)
PROJRTOS	= $(SRCDIR)/rtos

.PHONY:	rsrc all group1 group2 group3 group4 license setup

all:	rsrc group1 group2 group3 group4 license \
	    $(SRCDIR)/FreeRTOSConfig.h
	@echo "****************************************************************"
	@echo "Your project in subdirectory $(PROJRTOS) is now ready."
	@echo
...
rsrc:
	...
	@if [ ! -d $(LIBOPENCM3DIR) -o ! -f $(LIBOPENCM3DIR)/Makefile ] ; then \
		echo "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!" ; \
	...
	@if [ ! -f $(LIBOPENCM3DIR)/lib/libopencm3_stm32f1.a ] ; then \
		echo "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!" ; \
...
#
$(SRCDIR)/FreeRTOSConfig.h:
	@echo "Editing $(SRCDIR)/FreeRTOSConfig.h"
	sed <$(FREERTOSDIR)/FreeRTOS/Demo/CORTEX_STM32F103_Primer_GCC/FreeRTOSConfig.h \
	    >$(SRCDIR)/FreeRTOSConfig.h -f $(SRCDIR)/alters.sed
